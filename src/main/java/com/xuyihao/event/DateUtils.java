...
public class DateUtils {private static final String DATE_TIME_FORMAT = "yyyy-MM-dd HH:mm:ss";
    ...
    public static String formatYear(Date date) {
        java.text.SimpleDateFormat sdf = new java.text.SimpleDateFormat(YEAR_FORMAT);
        String dateFormate = sdf.format(date);
        return dateFormate;
    }
    ...
    public static String formatYearMonth(Date date) {
        java.text.SimpleDateFormat sdf = new java.text.SimpleDateFormat(YEAR_MONTH_FORMAT);
        String dateFormate = sdf.format(date);
        return dateFormate;
    }
    ...
    public static String formatDateHourMinute(Date date) {
        java.text.SimpleDateFormat sdf = new java.text.SimpleDateFormat(DATE_HOUR_MINUTE_FORMAT);
        String dateFormate = sdf.format(date);
        return dateFormate;
    }
